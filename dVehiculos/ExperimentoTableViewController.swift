...
class ExperimentoTableViewController: UITableViewController {
    ...
    func save(name: String) {
        ...
        // 2
        let entity =
            NSEntityDescription.entity(forEntityName: "Experimento",
                                       in: managedContext)!
        ...
        // 3
        person.setValue(name, forKeyPath: "nombre")
    ...
    override func tableView(_ tableView: UITableView,
        ...
        -> UITableViewCell {
            ...
            cell.labelExperimento.text = person.value(forKeyPath: "nombre") as? String
            cell.labelNombre.text = person.value(forKeyPath: "nombre") as? String
            cell.labelFecha.text = person.value(forKeyPath: "nombre") as? String
